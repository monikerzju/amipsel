...
tile:
	...
	cat $(DIR)/build/verilog/tile/dual_port_lutram.v >> build/verilog/tile/mycpu_top.v
	rm $(DIR)/build/verilog/tile/firrtl*
	rm $(DIR)/build/verilog/tile/single_port_ram.v
	rm $(DIR)/build/verilog/tile/dual_port_ram.v
	rm $(DIR)/build/verilog/tile/dual_port_lutram.v
